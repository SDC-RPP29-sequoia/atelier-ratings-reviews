...
scp -i "atelier-sequoia-server.cer" ratings_reviews.sql ubuntu@ec2-3-144-7-70.us-east-2.compute.amazonaws.com:~/
...
sudo -u postgres psql -h 73.229.57.230 -d ratings_reviews -f ratings_reviews.sql # for when authorization is required
